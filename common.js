...
function primeProfile3DViewer(config) {
  ...
  if (isCompactDesktop) {
    ...
    viewer.setAttribute('camera-target', '0m 0.18m 0m');
    viewer.setAttribute('camera-orbit', '0deg 78deg 1.42m');
    viewer.setAttribute('min-camera-orbit', 'auto 78deg 1.42m');
    viewer.setAttribute('max-camera-orbit', 'auto 78deg 1.42m');
